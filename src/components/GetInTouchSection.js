...
const GetInTouchSection = () => {
  return (
    <section className="pt-10 py-14 md:p-20">
      <div className="about-sec-title-div md:mb-14">
        <h2 className="about-sec-title text-3xl md:text-4xl lg:text-5xl font-bold pb-3 ">GET IN TOUCH</h2>
        <hr className="sec-title-hr" />
      </div>
      <div className="contact-div grid md:grid-cols-2 gap-x-2 gap-y-6 w-3/5 mx-auto">
        <div>
        ...
        <textarea placeholder="MESSAGE" className="text-blue-400 text-lg rounded-md font-bold bg-transparent border-blue-400 border-opacity-50 mb-4 p-3"></textarea>
      </div>
